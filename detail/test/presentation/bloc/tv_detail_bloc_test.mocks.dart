...
// in detail/test/presentation/bloc/tv_detail_bloc_test.dart.
...
import 'package:detail/domain/usecase/get_watchlist_status.dart' as _i10;
import 'package:detail/domain/usecase/remove_watchlist.dart' as _i12;
import 'package:detail/domain/usecase/save_watchlist.dart' as _i11;
import 'package:detail/domain/usecase/tv/get_tv_detail.dart' as _i4;
import 'package:detail/domain/usecase/tv/get_tv_recommendation.dart' as _i8;
...
class MockSaveWatchlist extends _i1.Mock implements _i11.SaveWatchlist {
  ...
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(
          _i7.MovieDetail? movie, int? option) =>
      (super.noSuchMethod(Invocation.method(#execute, [movie, option]),
