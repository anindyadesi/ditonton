...
void main() {
  ...
  group('get Now Playing Tv', () {
    final tMovieList = MovieResponse.fromJsonTv(
  ...
  group('get TV detail', () {
    final tId = 1;
    final tMovieDetail = MovieDetailResponse.fromJsonTv(
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/movie_detail_tv.json'), 200));
      // act
  ...
  group('search tvs', () {
    final tSearchResult = MovieResponse.fromJsonTv(
